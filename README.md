...
> Note: This is a modified alice which remove Chopper, package info plus, save function and better player for video player since I'm not using it. Will try to update all deps to the latest
